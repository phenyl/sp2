...
describe("update() can immutably update objects using", () => {
  ...
  describe("$set operator,", () => {
    ...
    it("returns the same object when the result is unchanged", () => {
      const obj = { name: { first: "Shin", last: "Doe" } };
      const operation = { $set: { "name.first": "Shin" } };

      const updatedObject = update(obj, operation);
      assert.strictEqual(obj, updatedObject);
    });
  ...
  describe("$inc operator,", () => {
    ...
    it("returns the same object when the result is unchanged", () => {
      const obj = { foo: { bar: 123 }, baz: { biz: 456 } };
      const operation = { $inc: { "foo.bar": 0, "baz.biz": 0 } };
      const updatedObject = update(obj, operation);
      assert.strictEqual(obj, updatedObject);
    });
  ...
  describe("$min operator,", () => {
    ...
    it("returns the same object when the result is unchanged", () => {
      const obj = { physical: { height: 168.3 } };
      const operation = { $min: { "physical.height": 168.33 } };
      const updatedObject = update(obj, operation);
      assert.strictEqual(obj, updatedObject);
    });
  ...
  describe("$mul operator,", () => {
    ...
    it("returns the same object when the result is unchanged", () => {
      const obj = { current: { rate: 1.3 } };
      const operation = { $mul: { "current.rate": 1 } };
      const updatedObject = update(obj, operation);
      assert.strictEqual(obj, updatedObject);
    });
  ...
  describe("$addToSet operator,", () => {
    ...
    it("returns the same object when the result is unchanged", () => {
      const obj = { gameCompanies: { hardware: ["Nintendo", "Microsoft"] } };
      const operation = {
        $addToSet: {
          "gameCompanies.hardware": { $each: ["Microsoft"] },
        },
      };
      const updatedObject = update(obj, operation);
      assert.strictEqual(obj, updatedObject);
  ...
  describe("$pop operator,", () => {
    ...
    it("returns the same object when the result is unchanged", () => {
      const obj = { gameCompanies: { hardware: [] } };
      const operation = { $pop: { "gameCompanies.hardware": -1 } };
      const updatedObject = update(obj, operation);
      assert.strictEqual(obj, updatedObject);
    });
  ...
  describe("$pull operator,", () => {
    ...
    it("returns the same object when the result is unchanged", () => {
      const operation = { $pull: { langs: { type: "XXX" } } };
      const updatedObject = update(obj, operation);
      assert.strictEqual(obj, updatedObject);
    });
  ...
  describe("$push operator,", () => {
    ...
    it("returns the same object when the result is unchanged", () => {
      const obj = { gameCompanies: { hardware: ["Sony", "Microsoft"] } };
      const operation = { $push: { "gameCompanies.hardware": { $each: [] } } };
      const updatedObject = update(obj, operation);
      assert.strictEqual(obj, updatedObject);
    });
  ...
  describe("$bit operator,", () => {
    ...
    it("does nothing and returns the same object when an empty operation is given", () => {
      const obj = { info: { flags: undefined } };
      const operation = {
        $bit: { "info.flags": {} },
      };
  ...
  describe("$unset operator,", () => {
    ...
    it("does nothing and returns the same object when the position designed by docPath doesn't exist", () => {
      const obj = { foo: { bar: 1 } };
      const operation = {
        $unset: { "hoge.fuga": "" },
      };
